...
public class ClearCommand extends CommandManager.Subcommand {
    public ClearCommand(CommandManager commandManager) {
        // 汉化文本clear entities using rules in WorldCleaner
        super(commandManager, "clear", "按 WorldCleaner 规则清理实体");
    }
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String[] args) {
        ...
        if (module == null || !module.isLoaded()) {
            // 汉化文本WorldCleaner module is disabled!
            MessageUtils.sendMessage(true, sender, "&7WorldCleaner 模块已被禁用！");
            return true;
        }
        ...
        switch (type) {
            case "items":
                ...
                // 汉化文本Successfully removed
                return MessageUtils.sendMessage(true, sender, "&7已成功清理 &e" + ai.get() + " &7个物品。");
            case "creatures":
                module.getAllowedWorldsStream()
                ...
                // 汉化文本Successfully removed
                return MessageUtils.sendMessage(true, sender, "&7已成功清理 &e" + ai.get() + " &7个生物。");
            case "projectiles":
                module.getAllowedWorldsStream()
                ...
                // 汉化文本Successfully removed
                return MessageUtils.sendMessage(true, sender, "&7已成功清理 &e" + ai.get() + " &7个投掷物。");
            default:
                // 汉化文本Invalid clear type:
