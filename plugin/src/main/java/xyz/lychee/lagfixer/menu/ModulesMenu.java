        ...
        for (AbstractModule module : modules) {
            ...
            this.itemClickEvent(slot, () -> {
                ...
                if (meta != null) {
                    ...
                    // 汉化文本Performance:
                    lore.add(MessageUtils.fixColors(null, " &8{*} &7性能: " + Language.getSerializer().serialize(module.getImpact().getComponent())));
                    lore.add("");
                    // 汉化文本Click to modify configuration!
                    lore.add(MessageUtils.fixColors(null, "&b&n点击以修改配置！"));
                    lore.add("");
                    // 汉化文本Description:
