...
public class ExplosionOptimizerModule extends AbstractModule implements Listener {
    ...
    public ExplosionOptimizerModule(LagFixer plugin, ModuleManager manager) {
        super(plugin, manager, Impact.HIGH, "ExplosionOptimizer",
                new String[]{
                        // 汉化文本Limits explosion power and prevents chain reactions to reduce lag and destruction.
                        "限制爆炸威力并防止连锁反应，以减少卡顿与破坏。",
                        // 汉化文本Useful for servers with frequent TNT, creepers, or End Crystal usage.
                        "适用于经常使用 TNT、苦力怕或末影水晶的服务器。",
                        // 汉化文本Prevents excessive explosions from causing performance issues.
                        "防止爆炸过于频繁导致性能问题。",
                        // 汉化文本Maintains stable server performance while controlling destructive events.
                        "在控制破坏性事件的同时，保持服务器性能稳定。"
                },
