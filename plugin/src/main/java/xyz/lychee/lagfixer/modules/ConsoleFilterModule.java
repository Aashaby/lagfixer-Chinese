...
public class ConsoleFilterModule extends AbstractModule {
    ...
    public ConsoleFilterModule(LagFixer plugin, ModuleManager manager) {
        super(plugin, manager, AbstractModule.Impact.VISUAL_ONLY, "ConsoleFilter",
                new String[]{
                        // 汉化文本Filters console messages based on predefined rules.
                        "根据预设规则过滤控制台消息。",
                        // 汉化文本Enhances clarity by selectively displaying essential messages.
                        "通过选择性显示重要信息提升清晰度。",
                        // 汉化文本Reduces clutter and improves readability in multiplayer servers.
                        "减少刷屏，提高多人服务器的日志可读性。",
                        // 汉化文本Facilitates efficient server administration and enhances the user experience for both administrators and players.
