...
public abstract class AbstractModule {
    ...
    public void loadConfigFile() throws Exception {
        ...
        if (defStream == null) {
            // 汉化文本Couldn't find config file
            this.plugin.getLogger().warning("无法在资源文件中找到配置文件 " + this.name + ".yml");
            return;
        }
        ...
        if (!parent.exists() && !parent.mkdirs()) {
            // 汉化文本Could not create directory:
        ...
        if (mainCfg.isConfigurationSection(sectionPath)) {
            ...
            if (section != null) {
                ...
                // 汉化文本Configuration has been moved to
    ...
    public enum Impact {
        // 汉化文本VERY HIGH
        VERY_HIGH("<bold><gradient:#069e00:#0aff00>极高</gradient>"),
        // 汉化文本HIGH
        ...
        // 汉化文本VERY LOW
        VERY_LOW("<bold><gradient:#ab1e1a:#ff322b>很低</gradient>"),
        // 汉化文本VISUAL ONLY
        VISUAL_ONLY("<bold><gradient:#1a5eab:#26baff>仅显示</gradient>");
